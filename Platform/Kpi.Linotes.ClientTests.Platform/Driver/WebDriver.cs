...
using Kpi.Linotes.ClientTests.Platform.Enum;
using OpenQA.Selenium;
using OpenQA.Selenium.Chrome;
using OpenQA.Selenium.Remote;
using Serilog;
using IJavaScriptExecutor = Kpi.Linotes.ClientTests.Model.Platform.Drivers.IJavaScriptExecutor;

namespace Kpi.Linotes.ClientTests.Platform.Driver
{
